...
public class CustomChromeDriver extends ChromeDriver implements CustomSeleniumDriver {
    ...
    public byte[] takeScreenShot() {
        return getFullScreenshotAs(OutputType.BYTES);
    }

    @Override
    public File getScreenshot() {
        return getFullScreenshotAs(OutputType.FILE);
    }
